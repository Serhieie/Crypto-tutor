import{q as v,u as y,t as F,v as R,j as e,H as I,w as L,x as M,o as z,g as N,b as h,s as a,y as E,z as B,L as k,A as W,m as q,n as V,B as $}from"./index-3npeiCd2.js";import{M as P}from"./index-WuCEnfzy.js";const H=({windowSize:t})=>{const{showPassword:r}=v(),l=y(),i=F(R),m=()=>{l(M())},s=o=>{const d=o.target.value;l(z(d))},n=t.height>460?"md3:mt-9":"md3:mt-0";return e.jsxs(e.Fragment,{children:[e.jsxs("label",{className:`
        ${n}
